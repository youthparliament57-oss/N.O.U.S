...
class PrescriptionScanner {
    ...
    internal fun extractMedicines(text: String, blocks: List<OcrBlock>): List<PrescriptionMedicine> {
        ...
        // Find all medicine name occurrences using pre-compiled regexes to avoid re-compilation in loop.
    ...
    private companion object {
        ...
        // Pre-compiled Regex patterns to avoid re-compilation per method invocation / loop iteration.
        ...
        // Pre-compile medicine search Regexes to avoid creating ~35 Regex instances per prescription parsing pass.
