...
val MIGRATION_1_2: Migration = object : Migration(1, 2) {
    override fun migrate(db: SupportSQLiteDatabase) {
        ...
        try {
            createEpisodicMemories(db)
            createKgEntities(db)
            createKgEdges(db)
            createSemanticFacts(db)
            createMemoryEmbeddings(db)
            createRemainingTables(db)
            createFtsTablesAndTriggers(db)
...
private fun createEpisodicMemories(db: SupportSQLiteDatabase) {
    // ─── 1. Episodic memories ─────────────────────────────────
    db.execSQL("""
...
private fun createKgEntities(db: SupportSQLiteDatabase) {
    // ─── 2. KG entities ───────────────────────────────────────
    db.execSQL("""
...
private fun createKgEdges(db: SupportSQLiteDatabase) {
    // ─── 3. KG edges ──────────────────────────────────────────
    db.execSQL("""
...
private fun createSemanticFacts(db: SupportSQLiteDatabase) {
    // ─── 4. Semantic facts ────────────────────────────────────
    db.execSQL("""
...
private fun createMemoryEmbeddings(db: SupportSQLiteDatabase) {
...
private fun createRemainingTables(db: SupportSQLiteDatabase) {
...
private fun createFtsTablesAndTriggers(db: SupportSQLiteDatabase) {
